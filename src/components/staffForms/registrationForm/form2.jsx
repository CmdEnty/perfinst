...
const Form2 = (props) => {
  ...
  const [btnChange, setBtnChange] = React.useState({
    selectedSpecialNeeds: props.student.selectedSpecialNeeds,
  });
              ...
              >
                ...
                <Box sx={{ gridColumn: "span 7" }}>
                  <ColorRadioButtons
                    ...
                    onChange={
                      ((values.selectedSpecialNeeds = selectedSpecialNeeds),
                      selectedSpecialNeeds === "No"
                        ? (values.specialNeeds = "N/A")
                    ...
                    span2="Yes"
                    error={
                      !!touched.selectedSpecialNeeds &&
                      !!errors.selectedSpecialNeeds
                    }
                    msg3={
